...
(function (window, document, $) {
  ...
  var html = $('html'),
    body = $('body').addClass(localStorage.getItem('body-layout')),
    // appContent = $('.app-content'),
    mainMenu = $('.main-menu').addClass(localStorage.getItem('layoutStatus') ),
    menuType = body.attr('data-menu'),
    footer = $('.footer'),
    navbar = $('.header-navbar').addClass(localStorage.getItem('navbarStatus') ),
  ...
  $('.layout-name').on('click', function () {
    ...
    if (currentLayout === '') {
      body.removeClass('dark-layout semi-dark-layout').addClass(''); 
      mainMenu.removeClass('dark-layout').addClass('');
      navbar.removeClass('navbar-dark').addClass('navbar-light'); 
      localStorage.setItem('layoutStatus', 'menu-light');
      localStorage.setItem('navbarStatus', 'navbar-light'); 
      localStorage.setItem('body-layout', ''); 
    } else if (currentLayout === 'dark-layout') { 
      body.removeClass('semi-dark-layout').addClass('dark-layout'); 
      mainMenu.removeClass('menu-light').addClass('menu-dark');
      navbar.removeClass('navbar-light').addClass('navbar-dark');
      localStorage.setItem('layoutStatus', 'menu-dark');
      localStorage.setItem('navbarStatus', 'navbar-dark'); 
      localStorage.setItem('body-layout', 'dark-layout'); 
      ...
      localStorage.setItem('layoutStatus', 'menu-dark');
      localStorage.setItem('navbarStatus', 'navbar-light'); 
      localStorage.setItem('body-layout', 'semi-dark-layout'); 
    } else { 
      body.removeClass('dark-layout semi-dark-layout').addClass(''); 
