      ...
      <div class="card-body">
        ...
        <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('phone') is-invalid @enderror" id="register-phone" name="phone" placeholder="0123456789" aria-describedby="register-phone" tabindex="2" value="{{ old('phone') }}" />
            @error('phone')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
