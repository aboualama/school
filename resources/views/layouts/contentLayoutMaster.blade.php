...
<head>
  ...
  <link rel="shortcut icon" type="image" href="{{asset('uploads/image/setting/')}}/{{$settings->logo}}">
  <link href="https://fonts.googleapis.com/css2?family=Cairo:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600" rel="stylesheet">
