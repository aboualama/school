              ...
              <table data-vertable="ver5">
                <thead>
                  <tr class="row100 head">
                    <th class="column100 column1" data-column="column1">رقم السجل</th>
                    <th class="column100 column2" data-column="column2">وصف السجل </th>
                    ...
                    <th class="column100 column6" data-column="column6">  مدة الحفظ</th> 
                    <th class="column100 column6" data-column="column6">  نوع السجل</th> 
                  </tr>
                </thead>
                <tbody>  
                  ...
                  <tr  class="row100">
                    ...
                    <td class="column100 column1" data-column="column1"> {{$custody->record_no}} </td>
                    <td class="column100 column2" data-column="column2"> {{$custody->record_description}} </td> 
                    ...
                    <td class="column100 column6" data-column="column6"> {{$custody->recordtype->period->period}}  </td>
                    <td class="column100 column6" data-column="column6"> {{$custody->recordtype->title}}  </td>
