              ...
              <table data-vertable="ver5">
                <thead>
                  <tr class="row100 head"> 
                    <th class="column100 column1" data-column="column1">رقم مسلسل </th>
                    <th class="column100 column1" data-column="column1">رقم عام </th> 
                    <th class="column100 column1" data-column="column1">رقم خاص </th> 
                    <th class="column100 column1" data-column="column1">تاريخ الاستلام</th> 
                    <th class="column100 column1" data-column="column1">  تاريخ النشر</th> 
                    <th class="column100 column1" data-column="column1">رقم الورود </th>
                    <th class="column100 column1" data-column="column1">  جهة الورود  </th> 
                    <th class="column100 column1" data-column="column1">عنوان الكتاب</th> 
                    <th class="column100 column1" data-column="column1">المؤلف</th> 
                    <th class="column100 column1" data-column="column1">  الناشر</th> 
                    <th class="column100 column1" data-column="column1">مكان النشر</th> 
                    <th class="column100 column1" data-column="column1">  الملاحظات</th> 
                  </tr>
                </thead>
                <tbody>  
                  ...
                  <tr  class="row100"> 
                    <td class="column100 column1" data-column="column1"> {{$custody->serial_number}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->public_number}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->private_number}} </td> 
                    <td class="column100 column1" data-column="column1"> {{$custody->received_date}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->date_of_publication}} </td> 
                    <td class="column100 column1" data-column="column1"> {{$custody->receipt_number}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->book_supplier}} </td> 
                    <td class="column100 column1" data-column="column1"> {{$custody->book_title}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->author}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->publisher}} </td> 
                    <td class="column100 column1" data-column="column1"> {{$custody->place_of_publication}} </td>  
                    <td class="column100 column1" data-column="column1"> {{$custody->notes}} </td>   
                  </tr> 
                @endforeach
