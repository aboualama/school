            ...
            <div class="table100 ver5 m-b-110">
              <table data-vertable="ver5">
                <thead> 
					...
					<th class="column100 column2" data-column="column2">اسم الصنف </th> 
					<th class="column100 column3" data-column="column3">الوحدة</th> 
					<th class="column100 column4" data-column="column4">الكمية</th> 
					<th class="column100 column5" data-column="column5">  ملاحظات</th> 
                  </tr>
                </thead>
                <tbody>  
                  ...
                  <tr  class="row100"> 
					...
					<td class="column100 column2" data-column="column2"> {{$custody->item_name}} </td>
					...
					<td class="column100 column5" data-column="column5"> {{$custody->notes}} </td>  
                  </tr> 
                @endforeach
