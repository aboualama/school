              ...
              <table data-vertable="ver5">
                <thead>
                  <tr class="row100 head">  
                    <th class="column100 column1" data-column="column1">رقم العهده</th>
                    <th class="column100 column2" data-column="column2"> اسم العهده</th>
                    <th class="column100 column3" data-column="column3">العدد</th>
                    <th class="column100 column4" data-column="column4">تاريخ الاستلام</th> 
                    <th class="column100 column5" data-column="column5">توقيع المستلم</th> 
                    <th class="column100 column6" data-column="column6">تاريخ الاعادة</th> 
                    <th class="column100 column1" data-column="column1">توقيع مستلم العهدة المسترجعه</th> 
                  </tr>
                </thead>
                <tbody>  
                  ...
                  <tr  class="row100"> 
                    ...
                    <td class="column100 column1" data-column="column1"> {{$custody->custody_name}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->quantity}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->received_date}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->received_signature}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->retrieved_date}} </td>
                    <td class="column100 column1" data-column="column1"> {{$custody->recipient_signature}} </td>  
                  </tr> 
                @endforeach
